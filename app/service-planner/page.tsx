        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-base leading-7 text-stone-600 sm:text-lg">The service planner separates whole-service operations from the worship-team arrangement workflow, while keeping them connected. Leaders can prepare the run of show first, then refine worship keys, transitions, Scripture, songs, and rights below.</p>
            </div>
