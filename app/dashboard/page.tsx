...
import { BookOpenText, Brain, Building2, CheckCircle2, Footprints, Globe2, Heart, HeartHandshake, LayoutDashboard, MessageCircleHeart, MonitorSmartphone, Music2, Radio, Scale, ShieldCheck, ShoppingBag, Ticket, Users, UsersRound, WalletCards } from 'lucide-react';
...
const actions = [
  ...
  { title: 'Media Rights', description: 'Review upload terms, takedowns, rights clearance, and licensed provider catalogs.', href: '/media-rights', icon: Scale },
  { title: 'Release Readiness', description: 'Check blockers before public launch: media rights, care, aid, translations, tests, and providers.', href: '/release-readiness', icon: CheckCircle2 },
      ...
      <section className="px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-stone-600">Access live broadcasts, worship media, media-rights controls, scripture intelligence, presentations, care, rewards, workers, conferences, testimonies, church network, marketplace, AI operations, family discipleship, and global ministry tools from one organized route.</p>
          </div>
