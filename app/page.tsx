    ...
    <div className="min-h-screen bg-cream-50 pt-24">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-light leading-tight tracking-tight text-stone-800 md:text-7xl">
              A sanctuary operating system for churches, communities, and spiritual leaders.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-stone-600">
              Digital Church OS brings pastoral care, prayer rooms, live services, worship generation, transparent aid, giving, and community engagement into one professional platform built for trust.
            </p>
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/community-wall" className="inline-flex items-center justify-center rounded-full border border-stone-200 bg-white/80 px-7 py-4 text-sm font-semibold text-stone-700 transition hover:border-sage-300 hover:text-sage-700">
                Explore Community
              </Link>
            </div>
          </div>
          ...
          <div className="sanctuary-card relative p-8 shadow-2xl">
            ...
            <div className="relative">
              ...
              <div className="mt-8 rounded-3xl bg-stone-900 p-6 text-white">
                <p className="text-sm uppercase tracking-[0.25em] text-sage-200">Next service</p>
                <h3 className="mt-2 text-2xl font-light">Worship, teaching, care, and action in one flow.</h3>
                <Link href="/conferences" className="mt-5 inline-flex items-center text-sm font-semibold text-sage-200 hover:text-white">
                  View conferences <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="border-y border-cream-200 bg-white/60 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-sage-600">Core routes</p>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 rounded-[2rem] bg-stone-900 p-8 text-white shadow-2xl md:p-12">
            ...
            <p className="mt-5 max-w-2xl text-stone-300">
              The system is structured for multiple faith communities, transparent operations, protected member journeys, AI-assisted workflows, and scalable deployment.
            </p>
          ...
          <div className="sanctuary-card flex flex-col justify-between p-8">
            ...
            <div>
              <h3 className="mt-8 text-2xl font-light text-stone-800">Launch-ready posture</h3>
              <p className="mt-3 text-sm leading-6 text-stone-600">
                Hardened routing, strict build checks, authenticated sensitive workflows, and transparency-first design make the platform easier to deploy and trust.
              </p>
