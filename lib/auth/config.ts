...
// Never manufacture a production secret. Preview/build environments may import
// this configuration without one, but authentication requests must have a real
// NEXTAUTH_SECRET before production auth is considered operational.
    ...
    async authorize(credentials) {
      ...
      try {
        ...
        return {
          ...
          image: user.image,
          role: user.role,
          faithPreference: user.faithPreference,
        };
      } catch (err) {
